...
const RecycleView = props => {
    const { data = [], overscanCount = DEFAULT_OVERSCAN_COUNT, placeholderImage, renderHeader, renderBottom, headerHeight = 0, bottomHeight = 0, renderItem, onScroll, scrollTop, scrollTopByIndex, ...scrollViewProps } = props;
    ...
    return (<ScrollView {...scrollViewProps} scrollY onScroll={(e) => {
      ...
      {renderHeader && (<View className="recycle-view-header" style={{ height: headerHeight }}>
          {renderHeader()}
        </View>)}
      <View style={{
        position: 'relative',
